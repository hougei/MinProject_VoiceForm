...
export default function HomeContent(props) {
    ...
    return (
        ...
        >
            ...
            >
                <ul>
                    <li>Click "+" or the Microphone icon on the top right to start creating form</li>
                    <li>Use Voice Commands to add Fields, Options and Validations</li>
                    <li>Follow voice prompts to complete form creation</li>
                    <li>Use voice commands to input data</li>
                </ul>
